...
def test_tabela_pdo_eco_usih():
    ...
    with patch("builtins.open", m):
        ...
        assert pdo.tabela.at[0, "volume_util_inicial_hm3"] == 530.01
        assert pdo.tabela.at[0, "volume_util_inicial_percentual"] == 78.87
